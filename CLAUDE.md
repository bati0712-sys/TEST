...
| `ferrini` | 192.168.1.10 | `FERRINI` | sa | ERP interno — stock, kardex, ventas. **SQL 2014 Std. Optimizado 2026-06-09**: recovery SIMPLE (log 90GB→4GB, disco D:\ 0→381GB libres; antes FULL sin BACKUP LOG) + índices `IX_AppBF_*` en tablas HEAP (kardex/cabventa/cabguia/detcobros/almacen/maeart). Ver memoria `project_ferrini_10_optimizacion`. |
